...
1. Open the **Dayzi** app and sign in.
2. Go to **Profile → Privacy Settings**.
3. Tap **Delete Account**.
4. Confirm when prompted.

Your account is immediately marked for deletion and enters a **30-day grace
period**.
...
If you cannot access the app, email us at **dayzibusiness@gmail.com** from the
email address registered to your account, with the subject line
"**Delete My Account**". We will verify your identity and process the request.

---

## What happens after you request deletion

- Your account is marked for deletion and enters a **30-day grace period**.
...
- Your profile photo
- Events you created
- Your messages in event group chats
- Your notifications
- Your event group memberships and attendee entries
- Your push-notification (FCM) tokens
- Your cached data
...
Before deleting, you can export your personal data in JSON format from
**Privacy Settings → Download My Data** in the app.
